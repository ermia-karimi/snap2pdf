...
//         // --------- Share / Save ---------
//         try {
//             const maxShareSize = 40 * 1024 * 1024; // 40MB

//             if (blob.size > maxShareSize) {
//                 pdf.save("Snap2Pdf_compressed.pdf");
...
// // =========================
// // SMART CAPACITOR DETECTOR
// // =========================

// function detectCapacitor() {
//     const isNative = !!window.Capacitor?.isNativePlatform;
//     const hasPlugins = !!window.Capacitor?.Plugins;
//     return isNative || hasPlugins;
// }

// // ---- Create Safe Capacitor Mock for Browser ----
// if (!detectCapacitor()) {
//     console.warn("Capacitor not detected → Using mock mode.");
...
//                 console.log("Mock Share:", { title, text, url, files });
//                 alert("Sharing is only available on the Android app.");
//             }
//         }
//     };
// }
...
// const IS_NATIVE = detectCapacitor();
// console.log("Running on:", IS_NATIVE ? "Android (Capacitor)" : "Browser");


// // ======================================
// // REST OF YOUR APP (PDF, Images, etc.)
// // ======================================
...
// // ======================================
// // MAIN PDF GENERATOR + SMART SHARE
// // ======================================
...
//         const pdf = new window.jspdf.jsPDF({ unit: "px", format: pdfSize });

//         showToast("Processing images...");

//         for (const file of pickedImages) {
//             const dataUrl = await processImageFile(file, DEFAULT_MAX_DIM, DEFAULT_QUALITY);
//             const img = await loadImage(dataUrl);
...
//         // ======== SMART SHARE ========
//         if (IS_NATIVE && window.Capacitor?.Share) {
//             await window.Capacitor.Share.share({
//                 title: "Snap2Pdf",
